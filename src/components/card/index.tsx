  ...
  return (
    <article className="flex justify-between py-4">
      ...
      <div className="sm:w-[calc(100%-108px)] w-[calc(100%-92px)]">
        ...
        <User name={props.user.name} avatarSmallUrl={props.user.avatarSmallUrl} readingTime={props.user.readingTime} likedCount={props.user.likedCount} profileLink={props.user.profileLink}/>
      </div>
    </article>
  )
}
