export default function Avator(): JSX.Element {
  return (
    <a href="/" className="flex">
      <img className="w-8 h-8 rounded-full" src="https://storage.googleapis.com/zenn-user-upload/avatar/7a22d8b360.jpeg" alt=""  />
      <div className="ml-2 text-xs">
        <p className="">Thomas</p>
        <div>
          <time dateTime="2021-12-20T15:28:33+00:00" className="text-gray-400">3日前</time>・
          <span className="ml-1 text-gray-400">27 min read</span>
